...
pub struct Injector<'a> {
    injector_ptr: *mut bind::_FridaInjector,
    phantom: PhantomData<&'a bind::_FridaInjector>,
}

impl<'a> Injector<'a> {
    pub(crate) fn from_raw(injector_ptr: *mut bind::_FridaInjector) -> Injector<'a> {
        Injector {
            injector_ptr,
            phantom: PhantomData,
        }
    ...
    pub fn new() -> Self {
        Self::from_raw(unsafe { bind::frida_injector_new() })
    }
    ...
    pub fn in_process() -> Self {
        Self::from_raw(unsafe { bind::frida_injector_new_inprocess() })
    }
}
...
impl Drop for Injector<'_> {
    fn drop(&mut self) {
        unsafe {
            bind::frida_injector_close_sync(
                self.injector_ptr,
                std::ptr::null_mut(),
                std::ptr::null_mut(),
            );
            bind::frida_unref(self.injector_ptr as _)
        }
    }
}
...
impl<'a> Inject for Injector<'a> {
        ...
        E: AsRef<str>,
    {
        ...
        let id = unsafe {
            bind::frida_injector_inject_library_file_sync(
                self.injector_ptr,
                pid as bind::guint,
                path.as_ptr() as *const bind::gchar,
                entrypoint.as_ptr() as *const bind::gchar,
                data.as_ptr() as *const bind::gchar,
                std::ptr::null_mut(),
                &mut error,
            )
        };
        ...
        E: AsRef<str>,
    {
        ...
        let id = unsafe {
            let g_blob = bind::_frida_g_bytes_new(blob.as_ptr() as _, blob.len() as _);
            let id = bind::frida_injector_inject_library_blob_sync(
                self.injector_ptr,
                pid,
                g_blob,
                entrypoint.as_ptr() as *const bind::gchar,
            ...
            bind::_frida_g_bytes_unref(g_blob);
            id
        };
...
impl<'a> Inject for Device<'a> {
        ...
        E: AsRef<str>,
    {
        ...
        let id = unsafe {
            bind::frida_device_inject_library_file_sync(
                self.device_ptr,
                pid as bind::guint,
                path.as_ptr() as *const bind::gchar,
                entrypoint.as_ptr() as *const bind::gchar,
        ...
        E: AsRef<str>,
    {
        ...
        let id = unsafe {
            let g_blob = bind::_frida_g_bytes_new(blob.as_ptr() as _, blob.len() as _);
            let id = bind::frida_device_inject_library_blob_sync(
                self.device_ptr,
                pid,
                g_blob,
                entrypoint.as_ptr() as *const bind::gchar,
